...
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_NKopp')
	 Begin 
	  Alter Database [Assignment06DB_NKopp] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_NKopp;
	 End
	Create Database Assignment06DB_NKopp;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_NKopp;
...
AS
	...
	Join vEmployees as M
	 On E.ManagerID = M.EmployeeID
Order By C.CategoryID, P.ProductID, I.InventoryDate, Manager;
go
